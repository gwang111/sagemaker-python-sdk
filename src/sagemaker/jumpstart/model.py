...
class JumpStartModel(Model):
    ...
    def __init__(
        ...
        Args:
            ...
            additional_model_data_sources (Optional[Dict[str, Any]]): Additional location
                of SageMaker model data (default: None).
            accept_eula (bool): For models n Addition Model Data Sources that require a Model Access Config,
    ...
    def set_deployment_config(
        self, config_name: str, instance_type: str, accept_eula: Optional[bool] = False
    ) -> None:
